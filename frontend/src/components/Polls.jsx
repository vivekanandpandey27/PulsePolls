...
export const Poll = ({ data }) => {
  ...
  return (
    <div className='bg-slate-400 border border-neutral-900 rounded-2xl w-80 p-4 backdrop-blur-sm shadow-lg transition-all hover:shadow-slate-500 '>
      {/* LOGO AND TITLE */}
      <div className='flex space-x-3 mb-4'>
        <div className='flex-shrink-0'>
          <img 
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEzXk-Es5uSaQxsJbB5PnWfS_3mGLJLpHO-g&s" 
