...
const REACT_BASE_URL = import.meta.env.VITE_REACT_APP_BACKEND_BASE_URL;
 ...
 export const Completed_Poll = () => {
   ...
   return (
     ...
     (<div className='bg-violet-900 h-screen text-white flex justify-center items-start pt-10 text-4xl font-bold shadow-xl shadow-red-800 rounded-lg '>No Poll Completed Yet..!</div>) 
